...
var PATIENT_TEMPLATES=[
  ...
  },
  {
    ...
    scales:[
      ...
      {key:'BrunnstromUE',name:'Brunnstrom上肢分期',score:3,conclusion:'第Ⅲ期：痉挛期',data:{stage:3},date:Date.now()},
      {key:'BrunnstromLE',name:'Brunnstrom下肢分期',score:3,conclusion:'第Ⅲ期：痉挛期',data:{stage:3},date:Date.now()},
      {key:'BBS',name:'Berg平衡量表',score:18,conclusion:'<40分 高跌倒风险',data:{score:18},date:Date.now()},
      {key:'MMSE',name:'MMSE简易精神状态',score:24,conclusion:'正常',data:{orientation:9,memory:3,attention:4,recall:3,language:5},date:Date.now()}
    ],
    plan:{
