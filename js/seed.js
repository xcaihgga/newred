...
const SEED_DATA = {
  ...
  appointments: [
    { id: 'a1', patientId: 'p-lumbar', time: '08:30', date: 'today', type: '评估', note: '腰椎·首评', color: '#0e9488' },
    { id: 'a2', patientId: 'p-stroke', time: '10:30', date: 'today', type: '量表', note: 'Barthel + BBS', color: '#3b82c4' },
    { id: 'a3', patientId: 'p-cervical', time: '11:30', date: 'today', type: '治疗', note: '颈椎松动术', color: '#8b5fbf' },
    { id: 'a4', patientId: 'p-lumbar', time: '14:00', date: 'today', type: '治疗', note: '牵引 + 中频', color: '#0e9488' },
    { id: 'a5', patientId: 'p-tka', time: '15:30', date: 'today', type: '评估', note: 'TKA术后6周复查', color: '#d9804a' },
    { id: 'a6', patientId: 'p-stroke', time: '16:30', date: 'today', type: '治疗', note: '步态训练', color: '#3b82c4' }
  ],
  ...
  records: [
    { id: 'r1', patientId: 'p-stroke', type: 'treatment', title: '治疗记录', summary: '步态训练 + 平衡训练（Bobath）', date: '今天', time: '16:30', createdAt: Date.now() },
    { id: 'r2', patientId: 'p-lumbar', type: 'treatment', title: '治疗记录', summary: '骨盆牵引 20min + 中频电疗', date: '今天', time: '14:00', createdAt: Date.now() },
    { id: 'r3', patientId: 'p-stroke', type: 'scale', title: 'Berg 平衡量表', summary: '18/56 · 高跌倒风险', date: '今天', time: '10:35', createdAt: Date.now() },
    { id: 'r4', patientId: 'p-stroke', type: 'scale', title: 'Barthel 指数', summary: '35/100 · 中度依赖', date: '今天', time: '10:30', createdAt: Date.now() },
    { id: 'r5', patientId: 'p-lumbar', type: 'assessment', title: '主诉评估', summary: '主诉完成 · VAS 7/10 · 直腿抬高右侧(+)', date: '今天', time: '09:30', createdAt: Date.now() },
    { id: 'r6', patientId: 'p-cervical', type: 'plan', title: '康复方案', summary: '三阶段方案更新（脊髓型颈椎病）', date: '昨天', time: '15:40', createdAt: Date.now() - 86400000 },
    { id: 'r7', patientId: 'p-stroke', type: 'exam', title: '巴宾斯基征', summary: '阳性 · 神经科特殊检查', date: '昨天', time: '15:20', createdAt: Date.now() - 86400000 },
    { id: 'r8', patientId: 'p-cervical', type: 'assessment', title: '主诉评估', summary: '四肢麻木 · Hoffmann 征(+)', date: '昨天', time: '15:00', createdAt: Date.now() - 86400000 },
    { id: 'r9', patientId: 'p-lumbar', type: 'scale', title: 'Oswestry 功能障碍', summary: '58% · 重度功能障碍', date: '昨天', time: '11:00', createdAt: Date.now() - 86400000 },
    { id: 'r10', patientId: 'p-stroke', type: 'plan', title: '康复方案', summary: 'Bobath 技术 · 三阶段方案制定', date: '3天前', time: '14:00', createdAt: Date.now() - 3 * 86400000 },
    { id: 'r11', patientId: 'p-tka', type: 'photo', title: '体态照片', summary: '左膝正侧位照片 2 张', date: '3天前', time: '09:15', createdAt: Date.now() - 3 * 86400000 },
    { id: 'r12', patientId: 'p-tka', type: 'scale', title: 'Lysholm 膝关节评分', summary: '72/100 · 中等恢复', date: '3天前', time: '09:00', createdAt: Date.now() - 3 * 86400000 },
    { id: 'r13', patientId: 'p-shoulder', type: 'scale', title: 'Constant 肩关节评分', summary: '42/100 · 差，需积极康复', date: '1周前', time: '10:10', createdAt: Date.now() - 7 * 86400000 },
...
window.Seed = {
  ...
  getPatient: function (id) {
    return SEED_DATA.patients.find(function (p) { return p.id === id; });
  }
};
})();
